...
public class UpdateEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfempId = new javax.swing.JLabel();
        ...
        tfempId.setBackground(new java.awt.Color(102, 102, 102));
        tfempId.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tfempId.setForeground(new java.awt.Color(0, 0, 0));
        tfempId.setMaximumSize(new java.awt.Dimension(55, 25));
        tfempId.setMinimumSize(new java.awt.Dimension(50, 20));
        tfempId.setPreferredSize(new java.awt.Dimension(55, 25));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(tfempId, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try {
            Conn conn = new Conn();
            String query = "update  employee set name='" + name + "',fname='" + fname + "',dob='" + dob + "',salary='" + salary + "',address='" + address + "',phone='" + phone + "',education='" + education + "',designation='" + designation + "',nid='" + nid + "' where empId='" + EmpId + "'";
    ...
    private javax.swing.JLabel tfempId;
